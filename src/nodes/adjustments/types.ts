...
export interface ITypeAdjustmentChecker {
    attempt(originalType: string | GlsLine, actualValue: string | GlsLine): string | GlsLine | undefined;
}
...
export const getTypeAdjustment = (originalType: string | GlsLine, actualValue: string | GlsLine) => {
